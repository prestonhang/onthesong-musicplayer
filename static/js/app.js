...
var songs = [
    ...
    {   name: "16",
        ...
        audio: "{{ url_for('static', filename='songs/16.mp3') }}"
    },
    {
        ...
        audio: "{{ url_for('static', filename='songs/comeinsideofmyheart.mp3') }}"
    },
    {
        ...
        audio: "{{ url_for('static', filename='songs/justwannarock.mp3') }}"
    },
    {
        name: "20 Min",
        artist: "Lil Uzi Vert",
        ...
        audio: "{{ url_for('static', filename='songs/20min.mp3') }}"
    },
    {
        name: "thom",
        artist: "Joji",
        ...
        audio: "{{ url_for('static', filename='songs/thom.mp3') }}"
    },
    {
        name: "fantasize",
        artist: "ericdoa",
        ...
        audio: "{{ url_for('static', filename='songs/fantasize.mp3') }}"
    },
    {
        name: "Heaven Sent",
        artist: "Tevomxntana",
        ...
        audio: "{{ url_for('static', filename='songs/heavensent.mp3') }}"
    }
]
...
function getSongRec(){
    //Open Flask URL
    const api_url = "http://127.0.0.1:5000/microservice";
...
searchInput.addEventListener('keypress', function(event){
    ...
    if(event.key === "Enter"){
        var userString = document.querySelector('.search-input').value;
        //Check each song's title, artist, and album in index for the searched input
